...
class Hyperparameters:
    ...
    min_lr_mul = float(os.environ.get("MIN_LR_MUL", 1e-3))
...
def main() -> None:
    ...
    def lr_mul(step: int) -> float:
        ...
        rem_iters = args.iterations - step
        if rem_iters > args.warmdown_iters: return 1.0
        return max(rem_iters / args.warmdown_iters, args.min_lr_mul)
